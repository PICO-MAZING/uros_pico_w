...
void timer_callback(rcl_timer_t *timer, int64_t last_call_time)
{
    ...
    case STOP:
        ...
        break;
    case FORWARD:
        forward_robot(&picobot, 100);
        break;
    case RIGHT:
        right_robot(&picobot, 100);
        break;
    case BACKWARD:
        backward_robot(&picobot, 100);
        break;
    case LEFT:
        left_robot(&picobot, 100);
        break;
    default:
        break;
    }
...
int main()
{
    ...
    rclc_executor_add_subscription(&executor, &subscriber_move, &msg_move, &move_callback, ON_NEW_DATA);
